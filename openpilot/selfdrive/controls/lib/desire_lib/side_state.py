...
class SideState:
  ...
  def update_lane_geometry(self,
    ...
    # Confirm a newly-open adjacent space over a short 100 ms window.  The
    # previous 200 ms gate made low-speed obstacle bypass start noticeably
    # late after the free side was already visible.
    available_count = max(1, int(0.1 / DT_MDL))
