...
class DesireHelper:
  def __init__(self):
    ...
    # Keep the lateral path offset briefly after the model reports that the
    # lane change is complete, avoiding an early return while clearing an
    # obstacle.
    self.lane_change_finish_hold = 0
    ...
    # blinker/ATC state (鞗愲掣 氤€靾橂摛 鞙犾)
    ...
    self.atc_type = ""
    self.is_changan_z6 = False
    self.atc_active = 0  # 0: 鞐嗢潓, 1: ATC 霃欖瀾, 2: 於╇弻
  ...
  def _update_params_periodic(self):
    if self.frame == 1 or self.frame % 100 == 0:
      ...
      selected = self.params.get("CarSelected3") or b""
      if isinstance(selected, bytes):
        selected = selected.decode("utf-8", errors="ignore")
      self.is_changan_z6 = str(selected).strip().lower() in {
        "changan z6", "changan z6 idd", "changan oushang z6",
        "changan oushang z6 idd", "oushang z6", "oushang z6 idd",
      }
  ...
  # 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  # blinkers/ATC (鞗愲掣 搿滌 鞙犾, side 瓿勳偘鞚€ 氤勱皽)
  # 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  ...
  def _update_atc_blinker(self, carrotMan, driver_blinker_state):
    ...
    atc_type = (atc_type or "").strip().lower()
    atc_blinker_state = BLINKER_NONE

    # Preserve a short Carrot lane-change command pulse.
    if self.carrot_lane_change_count > 0:
      ...
      atc_blinker_state = self.carrot_blinker_state
    elif atc_type.startswith(("turn left", "turn right")):
      if self.atc_active != 2:
        atc_blinker_state = BLINKER_LEFT if atc_type.startswith("turn left") else BLINKER_RIGHT
        self.atc_active = 1
        self.blinker_ignore = False
    elif atc_type.startswith(("fork left", "fork right", "atc left", "atc right")):
      if self.atc_active != 2:
        atc_blinker_state = BLINKER_LEFT if atc_type.startswith(("fork left", "atc left")) else BLINKER_RIGHT
        self.atc_active = 1
    else:
      self.atc_active = 0
  ...
  # 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  # per-side processing (頃奠嫭: 膦?鞖?氇憪 毵?頂勲爤鞛?瓿勳偘)
  # 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  def _process_sides(self, carstate, modeldata, radarState):
    ...
    # lane line info (HUD鞖?raw電?旮办〈雽€搿?leftLaneLine/rightLaneLine)
  ...
  def update(self, carstate, modeldata, lateral_active, lane_change_prob, carrotMan, radarState):
    ...
    atc_lane_change_requested = (
      atc_enabled and
      self.atc_type.startswith(("fork left", "fork right", "atc left", "atc right"))
    )
    atc_lane_change_manual_only = (
      atc_enabled and
      not driver_enabled and
      self.atc_type.startswith(("fork left", "atc left"))
    )
    ...
    # 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€ FSM 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    if not lateral_active or self.lane_change_timer > LANE_CHANGE_TIME_MAX or trailer_maneuver_blocked:
      ...
      if desire_enabled and side is not None:
        new_type = classify_maneuver_type(
          ...
          is_changan_z6=self.is_changan_z6,
          x_dist_to_turn=float(getattr(carrotMan, "xDistToTurn", 0.0)),
        )
      else:
        new_type = "none"
      ...
      # 鈹€ Lane change FSM 鈹€
        ...
        if self.lane_change_state == LaneChangeState.off:
          ...
          if desire_enabled and (not self.prev_desire_enabled or driver_desire_started) and \
            ...
            # 毵?雭?彀劆鞚?鞎勲媹氅? ATC 鞛愲彊 彀劆氤€瓴?牍勴櫆靹?            # (鞗愲掣 鞙犾: 彀劆 臁挫灛頃橁卑雮?geom 臧€電ロ晿氅?auto off, 鞎勲媹氅?on)
          ...
          if side is None:
            ...
            if not desire_enabled or below_lane_change_speed:
              ...
              # 彀劆氤€瓴?鞁滌瀾 臁瓣贝:
              # - side.lane_change_available電?BSD+object 韽暔(鞖旉惮靷暛)
              # - 頃橃毵?BSD 欷戩棎霃?torque override 項堨毄頃挫暭 頃橂瘈搿? BSD 攵勱赴毳?氤勲弰搿?霊?鞗愲掣 霃欖瀾 鞙犾)
              # LaneLineCheck=2: 鞁れ劆鞐愳劀霃?韱犿伂 override 項堨毄
              ...
              if start_gate:
                if solid_line_blocked:
                  ...
                  # driver blinker氅?氚旊 鞁滌瀾(鞗愲掣 鞙犾)
                  # 雼? object/bzd 毵夗灅鞚€ side.lane_change_available鞐愳劀 瓯鸽
          ...
          if lane_change_prob < 0.02 and self.lane_change_ll_prob < 0.01:
            ...
            self.lane_change_finish_hold = max(1, int(0.5 / DT_MDL))

        elif self.lane_change_state == LaneChangeState.laneChangeFinishing:
          if self.lane_change_finish_hold > 0:
            self.lane_change_finish_hold -= 1
