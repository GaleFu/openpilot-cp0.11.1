...
class CarSpecificEvents:
  ...
  def update(self, CS: car.CarState, CS_prev: car.CarState, CC: car.CarControl):
    ...
    elif self.CP.brand == 'changan':
      # The Z6 IACC main latch is owned by CarState and exposed as buttonEnable.
      # Do not create a conflicting PCM-disable event before engagement.
      events = self.create_common_events(CS, CS_prev, pcm_enable=False)
