...
GLYPH_PADDING = 6
# Keep direct HUD labels in the generated atlas even when translation files do
# not currently contain them.
EXTRA_CHARS = "–‑✓×°§•X⚙✕◀▶✔⌫⇧␣○●↳çêüñ–‑✓×°§•€£¥日一二三四五六"
...
def _char_sets():
  ...
  for codepoint_range in CJK_CODEPOINT_RANGES:
    unifont.update(map(chr, codepoint_range))
