...
window.HomeDrive = (() => {
  ...
  function renderActiveFrame(options = {}) {
    ...
    // During the first frame or while layout is being rebuilt the viewport
    // helper can legitimately return null.  Do not let that transient state
    // abort the render loop (it previously caused endless “无法播放媒体” and
    // prevented the video element from being presented).
