...
class MainLayout(Widget):
  ...
  def _handle_carrot_record_cmd(self, sm) -> bool:
    ...
    try:
      raw_record_request = ui_state.params.get_bool("ScreenRecord")
      if not local_recording and not raw_record_request:
        screen_record = False
        self._screen_record_param.store_pending(False, time.monotonic())
    except Exception:
      pass
