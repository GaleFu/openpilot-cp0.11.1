...
// The top-level SCons build invokes ld from /data/openpilot and passes resource
// paths beginning with "openpilot/". GNU ld -b binary derives the exported
// symbol names from that complete path, including the leading openpilot_.
