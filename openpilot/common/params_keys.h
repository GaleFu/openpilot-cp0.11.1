...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"SupportedCars_byd", {PERSISTENT, STRING}},
    {"SupportedCars_changan", {PERSISTENT, STRING}},
    ...
    // Z6 overlay: pass route turn intent and turn-speed targets into controlsd/modeld.
    // Existing devices still need the included enable_changan_navigation_control.sh
    // once because persistent Params values take precedence over these defaults.
    ...
    // One-time migration marker for the Z6 navigation-control defaults.
    {"ChanganNavigationControlConfigured", {PERSISTENT, BOOL, "0"}},
    ...
    // Mode 2 applies route speed while a corrected TBT maneuver is active.
    ...
    // Optional low-speed obstacle-avoidance experiment switch.  Keep it
    // registered here so Params.get_bool() is valid on all device builds.
    {"ObstacleAvoidanceExperimental", {PERSISTENT, BOOL, "0"}},
