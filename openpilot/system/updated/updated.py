...
def run(cmd: list[str], cwd: str | None = None) -> str:
  # Git output can contain user/branch text that is not valid UTF-8.  The
  # updater must keep running even when `git diff` reports such bytes.
  # Replace undecodable bytes instead of crashing the whole updated process.
