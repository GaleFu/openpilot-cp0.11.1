...
# 140 deg released the wheel before a sharp corner finished once the command
# cap no longer bound first. 200 deg keeps the same-side floor through the
# corner while staying inside the 260 deg command cap.
Z6_MID_TURN_HOLD_MAX_ANGLE = 200.0
