...
class CarControllerParams:
  ...
  Z6_LOW_SPEED_DRIVE_SCALE = 0.75
  Z6_LOW_SPEED_DRIVE_ACCEL_CAP = 0.12
  ...
  # Do not enter hydraulic CDD for tiny low-speed planner dips. A shallow
  # entry threshold causes repeated brake/drive mode toggling and a rocking
  # vehicle. Require a meaningful deceleration, then release smoothly.
  Z6_LOW_SPEED_CDD_ENTER = -0.20
  Z6_LOW_SPEED_CDD_EXIT = -0.02
